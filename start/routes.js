...
Route.get("endorsement/byPolicy", "EndorsementController.byPolicy").as("byPolicy");
Route.get("endorsement/byWebReqId", "EndorsementController.byWebReqId").as("byWebReqId");
